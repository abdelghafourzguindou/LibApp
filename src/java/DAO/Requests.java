...
public class Requests {
    ...
    public static String Book_All() {return "select * from Book;";}
    public static String Book_CodeBook(String Code) {return "select * from Book where CodeBook = '"+ Code +"';";}
    public static String Book_Disponible_All() {return "select * from Book where EtatBook = true;";}
    public static String Book_No_Disponible_All() {return "select * from Book where EtatBook = false;";}
    public static String Book_Categorie_All(String Categ) {return "select * from Book where CategorieBook = '"+ Categ +"';";}
    public static String Book_Update(Book b) {return "update Book set CodeBook = "  + b.getCodeBook() +
                                                            ",titreBook = "         + b.getTitreBook() +
                                                            ",auteurBook = "        + b.getAuteurBook() +
                                                            ",CategorieBook = "     + b.getNombreCopieBook() +
                                                            ",NombreCopieBook = "   + b.getNombreCopieBook() +
                                                            ",EtatBook = "          + b.getEtatBook();}
